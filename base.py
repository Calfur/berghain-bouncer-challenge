    ...
    try:
        ...
        while person_index <= max_iterations and status == "running":
            try:
                ...
                admitted_count = decision_data.get("admittedCount", admitted_count)
                rejected_count = decision_data.get("rejectedCount", rejected_count)
        ...
        print(f"Game ended with status: {status}, total decisions: {person_index + 1}")
